public class Employee {
    ...
    public static void main(String[] args) {
        ...
        double hraPercentage = 10; // Example: 20% of Basic Salary
        double daPercentage = 5;  // Example: 15% of Basic Salary

        // Create an Employee object with the specified details
        Employee emp = new Employee("Hasritha reddy", basicSalary, hraPercentage, daPercentage);
